...
ABACATE_PAY_API_KEY = os.environ.get("ABACATE_PAY_API_KEY", "")
ABACATE_PAY_WEBHOOK_SECRET = os.environ.get("ABACATE_PAY_WEBHOOK_SECRET", "")
ABACATE_PAY_RETURN_URL = os.environ.get("ABACATE_PAY_RETURN_URL", "")
ABACATE_PAY_WEBHOOK_URL = os.environ.get("ABACATE_PAY_WEBHOOK_URL", "")
ABACATE_PAY_PREMIUM_PRODUCT_ID = os.environ.get("ABACATE_PAY_PREMIUM_PRODUCT_ID", "vestlink-premium")
